...
const Navigtaion = () => {
  ...
  return (
    <Fragment>
      <nav className="fixed flex justify-center w-screen top-0 left-1/2 -translate-x-1/2 border-b-2 border-solid border-gray-300">
        <div className="inline-flex py-5 justify-between w-full max-w-5xl h-30 items-center">
          <Link passHref href="/">
            <ImageWrapper src={Logo} alt="searchIcon" />
          </Link>
          <div className="flex px-2 py-1 items-center border border-solid border-black space-x-2">
            <ImageWrapper
              src={searchIcon}
              width={20}
              height={20}
